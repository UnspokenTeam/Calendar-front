            ...
            <div
                ...
                <div className="flex flex-col self-center justify-center w-3/4 space-y-5 flex-grow">
                    ...
                    <div className="space-y-3">
                        <Input startIcon={UserRound} placeholder="Имя пользователя" type="username"/>
                        <Input startIcon={Mail} placeholder="Электронная почта" type="email"/>
                        <Input startIcon={Key} placeholder="Пароль" type="password"/>
                    </div>
